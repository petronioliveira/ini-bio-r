...
E o arquivo `dadosMater15.xlsx`que pode ser obtido [aqui](https://github.com/petronioliveira/Arquivos/raw/master/dadosMater15.xlsx) e baixado para o seu diretório de trabalho.
...
O caminho (*path*), usado no comando, é o do arquivo no computador do autor. Você deverá escrever o caminho no seu computador. Observe o uso de barra comum (não invertida). Se o arquivo foi baixado no diretório de trabalho ativo, basta escrever `"dadosMater15.xlsx"`.
...
Uma medida de localização bastante utilizada são os [quantis](anchor) que são pontos estabelecidos em intervalos regulares que dividem a amostra em subconjuntos iguais. Se estes subconjuntos são em número de 100, são denominados de [percentis](anchor); se são em número de em 10, são os [decis](anchor) e em número de 4, são os [quartis](anchor). 
...
<https://learningstatisticswithr.com/book/descriptives.html>
