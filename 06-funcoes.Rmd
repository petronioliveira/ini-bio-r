...
Por exemplo, a área de um circulo é igual a $\pi$ x raio^2. Usando o R para calcular a área do círculo, podemos criar uma função que faça este trabalho:
...
Podemos criar uma função para o Indice de Massa Corporal, sabendo que ele é igual ao peso (kg) dividido pela altura^2:
